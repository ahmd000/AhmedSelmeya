...
class UpdateUser extends StatefulWidget {
  static String id = 'UpdateUser';

//  final Employee employee;
//  EmployeeScreen(this.employee);
  @override
  _updatUserState createState() => new _updatUserState();
}

class _updatUserState extends State<UpdateUser> {
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      if (_globalKey.currentState.validate()) {
                        ...
                        Firestore.instance.collection('Data').document().updateData({
